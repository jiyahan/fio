...
test: source/fio/fio.d source/fio/poll.d source/fio/kqueue.d
	$(COMPILER) -main -unittest source/fio/fio.d source/fio/poll.d source/fio/kqueue.d -gc -oftest -Isource/fio/
